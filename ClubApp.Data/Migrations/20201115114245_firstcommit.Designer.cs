...
namespace ClubApp.Data.Migrations
{
    ...
    [Migration("20201115114245_firstcommit")]
            ...
            modelBuilder.Entity("ClubApp.Data.Entities.ApiRefreshToken", b =>
                {
                    ...
                    b.HasIndex("ApiClientId", "UserTenantApplicationRoleId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ClubApp.Data.Entities.ApiRefreshToken", b =>
                {
                    ...
                    b.HasOne("ClubApp.Data.Entities.UserTenantApplicationRole", "UserTenantApplicationRole")
                        .WithMany("ApiRefreshTokens")
                    ...
                    b.Navigation("UserTenantApplicationRole");
                });
